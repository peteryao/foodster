...
# ADMINS = (('Webmaster', 'webmaster@creativemedia.ucdavis.edu'),)
# SERVER_EMAIL = 'no-reply@asucd-python.ucdavis.edu'
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get('SECRET_KEY', 'gqe-y=h+8f4a8uz5)39c2nkx&2l%1ksty)cbom538)se883t*r')
